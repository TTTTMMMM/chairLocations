...
import AddDropBeaches from "./AddDropBeaches";
...
class RentalAgentBeachesManagementComponent extends Component<{}, {}> {
         ...
         <>
            <div style={divFlexRowL}>
               ...
               <section className={"resultsside"} style={resultsSideStyling}>
                  <AddDropBeaches myPanel={this.myPanel}></AddDropBeaches>
               </section>
            </div>
         </>
      );
...
export default RentalAgentBeachesManagementComponent;
